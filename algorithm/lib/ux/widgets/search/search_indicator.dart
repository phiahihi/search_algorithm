...
import 'package:algorithm/models/search_model.dart';
  ...
  Offset _getIndicatorOffset(SearchModel number) {
    ...
    try {
      final RenderBox? rObject =
          number.key.currentContext!.findRootAncestorStateOfType();
      final RenderBox? parentObject =
          widget.parentKey.currentContext!.findAncestorRenderObjectOfType();
